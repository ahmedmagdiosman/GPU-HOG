...
# 70 "../src/Vec2.hpp"
extern __attribute__((device)) __inline__ struct float2 *_ZNK4Vec211getConstPtrEv(const struct Vec2 *const);
# 31 "../src/Vec2.cu"
extern __attribute__((device)) void _ZN4Vec2C1ERKS_(struct Vec2 *const, const struct Vec2 *);
extern __attribute__((device)) void _ZN4Vec2C2ERKS_(struct Vec2 *const, const struct Vec2 *);
# 16 "../src/Vec2.cu"
extern __attribute__((device)) void _ZN4Vec2C1Eii(struct Vec2 *const, int, int);
extern __attribute__((device)) void _ZN4Vec2C2Eii(struct Vec2 *const, int, int);
# 23 "../src/Vec2.cu"
extern __attribute__((device)) void _ZN4Vec2C1Ev(struct Vec2 *const);
extern __attribute__((device)) void _ZN4Vec2C2Ev(struct Vec2 *const);
# 50 "../src/Vec2.cu"
extern __attribute__((device)) void _ZN4Vec2D1Ev(struct Vec2 *const);
extern __attribute__((device)) void _ZN4Vec2D2Ev(struct Vec2 *const);
...
__asm__(".align 2");
# 70 "../src/Vec2.hpp"
 __attribute__((nv_linkonce_odr)) __attribute__((device)) __inline__ struct float2 *_ZNK4Vec211getConstPtrEv( const struct Vec2 *const this){
# 70 "../src/Vec2.hpp"
{ int __T26;
# 70 "../src/Vec2.hpp"
{
...
__asm__(".align 2");
# 31 "../src/Vec2.cu"
 __attribute__((device)) void _ZN4Vec2C1ERKS_( struct Vec2 *const this,
# 31 "../src/Vec2.cu"
...
__asm__(".align 2");
 __attribute__((device)) void _ZN4Vec2C2ERKS_( struct Vec2 *const this, const struct Vec2 *__T27){ { _ZN4Vec2C1ERKS_(this, __T27); }}
__asm__(".align 2");
# 16 "../src/Vec2.cu"
 __attribute__((device)) void _ZN4Vec2C1Eii( struct Vec2 *const this,
# 16 "../src/Vec2.cu"
int width,
# 16 "../src/Vec2.cu"
int height){
...
__asm__(".align 2");
 __attribute__((device)) void _ZN4Vec2C2Eii( struct Vec2 *const this, int __T28, int __T29){ { _ZN4Vec2C1Eii(this, __T28, __T29); }}
__asm__(".align 2");
# 23 "../src/Vec2.cu"
 __attribute__((device)) void _ZN4Vec2C1Ev( struct Vec2 *const this){
# 23 "../src/Vec2.cu"
{
# 24 "../src/Vec2.cu"
...
__asm__(".align 2");
 __attribute__((device)) void _ZN4Vec2C2Ev( struct Vec2 *const this){ { _ZN4Vec2C1Ev(this); }}
__asm__(".align 2");
# 50 "../src/Vec2.cu"
 __attribute__((device)) void _ZN4Vec2D1Ev( struct Vec2 *const this){
# 50 "../src/Vec2.cu"
{
# 51 "../src/Vec2.cu"
free(((void *)(this->data)));
...
__asm__(".align 2");
 __attribute__((device)) void _ZN4Vec2D2Ev( struct Vec2 *const this){ { _ZN4Vec2D1Ev(this); }}
